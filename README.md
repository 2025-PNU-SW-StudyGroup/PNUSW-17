...
|--------------------|:----:|:---------:|:------------:|
| **사용자 정보 기록**      | O    |     X     | X            |
| **현재 위치 안전 여부 안내** | O    |     X     | O |
| **대피소 위치 정보 제공**   | O (사용자 위치 기반) | O (직접 검색) | O (사용자 위치 기반) |
| **커뮤니티 기능 제공**     | O    |     X     | X            |
| **재난 뉴스 확인**       | O    |     O     | X            |
| **재난 정보 확인**       | O    | O          | X            |
| **재난 대응 챗봇**             | O    | X          | X            |
...
ResQ: 현재 위치 기반으로 주변에서 발생한 재난 정보를 홈 화면에서 실시간으로 확인할 수 있는 기능을 제공합니다. <br><br>
>7) 챗봇 <br>
안전디딤돌 / 전국 대피소: 해당 기능은 제공하지 않습니다. <br>
ResQ: 재난 시 궁금한 내용을 실시간으로 질문하고 답변받을 수 있도록 제공합니다. 정적인 정보가 아닌, 상황에 맞춘 대화형 응답 지원으로 차별화된 대응 경험을 제공합니다.  <br><br>
>8) 체크리스트 <br>
안전디딤돌 / 전국 대피소: 해당 기능은 제공하지 않습니다. <br>
...
>10) 포인트 <br>
안전디딤돌 / 전국 대피소: 해당 기능은 제공하지 않습니다. <br>
ResQ: 글 작성, 댓글 작성, 후원 참여 시 포인트가 적립되며, 사용자의 기여도와 활동 내역을 시각적으로 확인할 수 있는 포인트 시스템을 제공합니다. <br><br>
